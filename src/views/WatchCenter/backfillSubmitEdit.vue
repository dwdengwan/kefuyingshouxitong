        ...
        <el-form :model="activeData" ref="leftForm" label-width="120px" :rules="rules">
          ...
          <div class="my-input">
            <el-form-item label="新表编号：" prop="newMeterNo">
              <el-input v-model="activeData.newMeterNo" size="mini" clearable></el-input>
            </el-form-item>
          </div>

          <div class="my-input">
            <el-form-item label="新表起码：" prop="newMeterNum">
              <el-input v-model="activeData.newMeterNum" size="mini" clearable type="Number" @blur="blurTest('new')"></el-input>
            </el-form-item>
          </div>
      ...
      <el-form :inline="true" class="formBill" label-width="130px">
        ...
        <div class="kl-table">
          <el-table stripe highlight-current-row border :data="tableData" @row-click="rowClick">
            ...
            <el-table-column min-width="120" label="旧表出厂编号" prop="oldFactoryNo" show-overflow-tooltip>
            </el-table-column>
